...
app.post("/submit", (req, res) => {
  ...
  var word1 = Math.floor(Math.random()* adj.length);
  var word2=Math.floor(Math.random()* noun.length);
  const fullname = adj[word1]+ " "+noun[word2];
  //console.log(name + " "+name2);
  //2. Send the index.ejs as a response and add the adjective and noun to the res.render
  res.render("index.ejs",{randName:fullname});
